...
class ResNet_IBN(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_classes=1000):
    '''
    def __init__(self, last_stride, block, layers, ibn_cfg=('a', 'a', 'a', None), num_classes=1000):
        self.inplanes = 64
...
def resnet50_ibn_a(pretrained_path, last_stride, pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        '''
        model.load_state_dict(torch.load(pretrained_path)) # add by lwp, 2020.8.19
    return model


def resnet101_ibn_a(pretrained_path, last_stride, pretrained=False, **kwargs):
...
def resnet50_ibn_b(pretrained_path, last_stride, pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    # adding last_stride by syl on 2020.08.19
    model = ResNet_IBN(last_stride=last_stride, 
                       block=Bottleneck_IBN,
                       layers=[3, 4, 6, 3],
                       ibn_cfg=('b', 'b', None, None),
...
def resnet101_ibn_b(pretrained_path, last_stride, pretrained=False, **kwargs):
